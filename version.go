...
// Version string
var Version = version{ApplicationName: PROGRAM_NAME, Version: BuildVersion, VersionLabel: BuildVersionLabel, Commit: BuildCommit, CompilationTimestamp: BuildCompilationTimestamp}
